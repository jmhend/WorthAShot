...
import com.example.worth_a_shot.utils.uil.cache.disc.DiscCacheAware;
import com.example.worth_a_shot.utils.uil.cache.memory.MemoryCacheAware;
import com.example.worth_a_shot.utils.uil.core.assist.ImageLoadingListener;
import com.example.worth_a_shot.utils.uil.core.assist.ImageSize;
import com.example.worth_a_shot.utils.uil.core.assist.MemoryCacheKeyUtil;
import com.example.worth_a_shot.utils.uil.core.assist.SimpleImageLoadingListener;
import com.example.worth_a_shot.utils.uil.core.display.BitmapDisplayer;
import com.example.worth_a_shot.utils.uil.core.display.FakeBitmapDisplayer;
...
public class ImageLoader {
	...
	public void displayImage(String uri, ImageView imageView) {
		displayImage(uri, imageView, null, null, true);
	}
	 ...
	 * @param imageView
	 *            {@link ImageView} which should display image
     * @param findIfNotCached
     * 			  true if the image should be downloaded or pulled from the SDcard if not in the cache, false otherwise.
	 * @throws RuntimeException
	 *             if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 */
	public void displayImage(String uri, ImageView imageView, boolean findIfNotCached) {
		displayImage(uri, imageView, null, null, findIfNotCached);
	}
	...
	public void displayImage(String uri, ImageView imageView, DisplayImageOptions options) {
		displayImage(uri, imageView, options, null, true);
	}
	...
	public void displayImage(String uri, ImageView imageView, ImageLoadingListener listener) {
		displayImage(uri, imageView, null, listener, true);
	}
	 ...
	 *             if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 */
	public void displayImage(String uri, ImageView imageView, DisplayImageOptions options, ImageLoadingListener listener, boolean findIfNotCached) {
		if (configuration == null) {
	...
	public void loadImage(Context context, String uri, ImageLoadingListener listener) {
		loadImage(context, uri, null, null, listener, true);
	}
	...
	public void loadImage(Context context, String uri, ImageSize minImageSize, ImageLoadingListener listener) {
		loadImage(context, uri, minImageSize, null, listener, true);
	}
	...
	public void loadImage(Context context, String uri, DisplayImageOptions options, ImageLoadingListener listener) {
		loadImage(context, uri, null, options, listener, true);
	}
	 ...
	 *            thread.
	 */
	public void loadImage(Context context, String uri, ImageSize minImageSize, DisplayImageOptions options, ImageLoadingListener listener, boolean findIfNotCached) {
		...
		displayImage(uri, fakeImage, optionsWithFakeDisplayer, listener, findIfNotCached);
	}
